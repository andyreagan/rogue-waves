...
% i*eps*u_t+eps^2*u_{xx}+2|u|^2u=0.
  ...
  L=pi*4; N=m; dt=.1/m; tmax=1; nmax=round(tmax/dt);
  ...
  fname = [SaveString num2str(N) 'pts_256plotted'];  %num2str(eps) 'eps_' 
  ...
  fname = [SaveString num2str(N) 'pts_512plotted'];  %num2str(eps) 'eps_'
  saveas(1,fname,'fig');       % save figure
  saveas(1,fname,'png');
  ...
  fname = [SaveString num2str(N) 'pts_1024plotted'];  %num2str(eps) 'eps_'
  saveas(1,fname,'fig');       % save figure
  saveas(1,fname,'png');
