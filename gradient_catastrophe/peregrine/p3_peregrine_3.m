...
% iu_t+u_{xx}+2|u|^2u=0.
  ...
  fname = ['peregrine_' num2str(N) 'pts_256plotted_' 'point001eps'];
  ...
  fname = ['peregrine_' num2str(N) 'pts_512plotted' 'point001eps'];
  saveas(1,fname,'fig');       % save figure
  saveas(1,fname,'png');
  ...
  fname = ['peregrine_' num2str(N) 'pts_1024plotted' 'point001eps'];
  saveas(1,fname,'fig');       % save figure
  saveas(1,fname,'png');
